...
function App() {
  ...
  return (
    <div>
      ...
      >
        <Alert severity="error" variant="filled" sx={{ minWidth: "20%" }}>
          <div>{errorMessage?.message}</div>
          <div>
            {errorMessage?.data ? renderErrorContent(errorMessage.data) : ""}
          </div>
        </Alert>
      </Snackbar>
      <Snackbar
      ...
      >
        <Alert severity="success" variant="filled" sx={{ minWidth: "20%" }}>
